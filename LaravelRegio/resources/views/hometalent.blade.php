...
<head>
    ...
    <link rel="stylesheet" href="../css/hometalent.css" />
...
<body>
    ...
    <main>
      ...
      <div class="wrapper">
        <div class="cards-wrapper">
          ...
          <!-- <div class="jobs">
            ...
            <p> Web Developer </p>
            <p> PT. Kreasi Rekayasa Indonesia </p>
            <p> Wirosari, Indonesia </p>
            <p> IDR 7.000.000 - 10.000.000 </p>
            <p> Full Time </p>
            <hr>
            <i class=fa fa-times><p> 07 Jan 2023 </p> </i>
          </div> -->
          <!-- <div class="jobs">
            <div class="icon">
      ...
      <div class="wrap-box">
        <div class="kotakcari">
            <input class="carikerja" type="text" placeholder="Cari Kerja "> 
        </div>
        <hr class="crkerja">
        <select class="lokasi">
