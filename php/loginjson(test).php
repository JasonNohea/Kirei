<?php
$database = file_get_contents("../json/account.json");
...
if ($success == TRUE) {
    ...
    header("location: ../html_talent/hometalent-loggedin.html", true, 301);
    //membuat kode di bawah header tidak diproses oleh website sehingga lebih aman
    exit();
} else {
    echo "Username/Password Salah";
    header("location: ../html_talent/hometalent.html", true, 301);
    exit();
}
